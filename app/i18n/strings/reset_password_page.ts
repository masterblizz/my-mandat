...
const reset_password_page = {
  ...
  passwordUpdated: { ms: "KATA LALUAN DIKEMASKINI", en: "PASSWORD UPDATED" },
  yourNewPasswordHasBeenSaved: { ms: "Kata laluan baharu anda telah disimpan.", en: "Your new password has been saved." },
  redirectingToLogin: { ms: "Mengalihkan ke log masuk…", en: "Redirecting to login…" },
  newPassword: { ms: "KATA LALUAN BAHARU", en: "NEW PASSWORD" },
  enterANewPasswordForYour: { ms: "Masukkan kata laluan baharu untuk akaun anda.", en: "Enter a new password for your account." },
  confirmPassword: { ms: "SAHKAN KATA LALUAN", en: "CONFIRM PASSWORD" },
