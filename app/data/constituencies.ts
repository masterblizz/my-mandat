...
// Real DUN (state assembly) constituency names for all 13 states, sourced
// from DOSM's (Dept. of Statistics Malaysia) official open-data GeoJSON
// (electoral_1_dun.geojson — see scripts/build-geo-data.mjs), ordered by
// code_dun (N.01, N.02, ...) to match generateConstituencies' index-based
// seat generation below. Previously only 6 states had curated names here
// (the rest, including Sabah and Sarawak, fell back to placeholder "DUN
// <state> <n>" labels) and a few of those 6 had reordered/misspelled
// entries — this replaces the whole table with the verified official set.
const DUN_NAMES: Record<string, string[]> = {
  johor: [
    "Buloh Kasap", "Jementah", "Pemanis", "Kemelah", "Tenang", "Bekok",
    "Bukit Kepong", "Bukit Pasir", "Gambir", "Tangkak", "Serom", "Bentayan",
    "Simpang Jeram", "Bukit Naning", "Maharani", "Sungai Balang", "Semerah", "Sri Medan",
    "Yong Peng", "Semarang", "Parit Yaani", "Parit Raja", "Penggaram", "Senggarang",
    "Rengit", "Machap", "Layang-Layang", "Mengkibol", "Mahkota", "Paloh",
    "Kahang", "Endau", "Tenggaroh", "Panti", "Pasir Raja", "Sedili",
    "Johor Lama", "Penawar", "Tanjung Surat", "Tiram", "Puteri Wangsa", "Johor Jaya",
    "Permas", "Larkin", "Stulang", "Perling", "Kempas", "Skudai",
    "Kota Iskandar", "Bukit Permai", "Bukit Batu", "Senai", "Benut", "Pulai Sebatang",
    "Pekan Nanas", "Kukup",
  ],
  kedah: [
    "Ayer Hangat", "Kuah", "Kota Siputeh", "Ayer Hitam", "Bukit Kayu Hitam", "Jitra",
    "Kuala Nerang", "Pedu", "Bukit Lada", "Bukit Pinang", "Derga", "Suka Menanti",
    "Kota Darul Aman", "Alor Mengkudu", "Anak Bukit", "Kubang Rotan", "Pengkalan Kundor", "Tokai",
    "Sungai Tiang", "Sungai Limau", "Guar Chempedak", "Gurun", "Belantek", "Jeneri",
    "Bukit Selambau", "Tanjong Dawai", "Pantai Merdeka", "Bakar Arang", "Sidam", "Bayu",
    "Kupang", "Kuala Ketil", "Merbau Pulas", "Lunas", "Kulim", "Bandar Baharu",
  ],
  kelantan: [
    "Pengkalan Kubor", "Kelaboran", "Pasir Pekan", "Wakaf Bharu", "Kijang", "Chempaka",
    "Panchor", "Tanjong Mas", "Kota Lama", "Bunut Payong", "Tendong", "Pengkalan Pasir",
    "Meranti", "Chetok", "Gual Periok", "Apam Putra", "Salor", "Pasir Tumboh",
    "Demit", "Tawang", "Pantai Irama", "Jelawat", "Melor", "Kadok",
    "Kok Lanas", "Bukit Panau", "Gual Ipoh", "Kemahang", "Selising", "Limbongan",
    "Semerak", "Gaal", "Pulai Chondong", "Temangan", "Kemuning", "Bukit Bunga",
    "Air Lanas", "Kuala Balah", "Mengkebang", "Guchil", "Manek Urai", "Dabong",
    "Nenggiri", "Paloh", "Galas",
  ],
  melaka: [
    "Kuala Linggi", "Tanjung Bidara", "Ayer Limau", "Lendu", "Taboh Naning", "Rembia",
    "Gadek", "Machap Jaya", "Durian Tunggal", "Asahan", "Sungai Udang", "Pantai Kundor",
    "Paya Rumput", "Kelebang", "Pengkalan Batu", "Ayer Keroh", "Bukit Katil", "Ayer Molek",
    "Kesidang", "Kota Laksamana", "Duyong", "Bandar Hilir", "Telok Mas", "Bemban",
    "Rim", "Serkam", "Merlimau", "Sungai Rambai",
  ],
  ns: [
    ...
    "Bagan Pinang", "Linggi", "Sri Tanjung", "Gemas", "Gemencheh", "Repah",
  ],
  pahang: [
    "Tanah Rata", "Jelai", "Padang Tengku", "Cheka", "Benta", "Batu Talam",
    "Tras", "Dong", "Tahan", "Damak", "Pulau Tawar", "Beserah",
    "Semambu", "Teruntum", "Tanjung Lumpur", "Inderapura", "Sungai Lembing", "Lepar",
    "Panching", "Pulau Manis", "Peramu Jaya", "Bebar", "Chini", "Luit",
    "Kuala Sentul", "Chenor", "Jenderak", "Kerdau", "Jengka", "Mentakab",
    "Lanchang", "Kuala Semantan", "Bilut", "Ketari", "Sabai", "Pelangai",
    "Guai", "Triang", "Kemayan", "Bukit Ibam", "Muadzam Shah", "Tioman",
  ],
  perak: [
    "Pengkalan Hulu", "Temengor", "Kenering", "Kota Tampan", "Selama", "Kubu Gajah",
    "Batu Kurau", "Titi Serong", "Kuala Kurau", "Alor Pongsu", "Gunong Semanggol", "Selinsing",
    "Kuala Sepetang", "Changkat Jering", "Trong", "Kamunting", "Pokok Assam", "Aulong",
    "Chenderoh", "Lubok Merbau", "Lintang", "Jalong", "Manjoi", "Hulu Kinta",
    "Canning", "Tebing Tinggi", "Pasir Pinji", "Bercham", "Kepayang", "Buntong",
    "Jelapang", "Menglembu", "Tronoh", "Bukit Chandan", "Manong", "Pengkalan Baharu",
    "Pantai Remis", "Astaka", "Belanja", "Bota", "Malim Nawar", "Keranji",
    "Tualang Sekah", "Sungai Rapat", "Simpang Pulai", "Teja", "Chenderiang", "Ayer Kuning",
    "Sungai Manik", "Kampong Gajah", "Pasir Panjang", "Pangkor", "Rungkup", "Hutan Melintang",
    "Pasir Bedamar", "Changkat Jong", "Sungkai", "Slim", "Behrang",
  ],
  perlis: [
    "Titi Tinggi", "Beseri", "Chuping", "Mata Ayer", "Santan", "Bintong",
    "Sena", "Indera Kayangan", "Kuala Perlis", "Kayang", "Pauh", "Tambun Tulang",
    "Guar Sanji", "Simpang Empat", "Sanglang",
  ],
  penang: [
    ...
    "Berapit", "Machang Bubuk", "Padang Lalang", "Perai", "Bukit Tengah", "Bukit Tambun",
    "Jawi", "Sungai Bakap", "Sungai Acheh", "Tanjong Bunga", "Air Putih", "Kebun Bunga",
    ...
    "Batu Maung", "Bayan Lepas", "Pulau Betong", "Telok Bahang",
  ],
  sabah: [
    "Banggi", "Bengkoka", "Pitas", "Tanjong Kapor", "Matunggong", "Bandau",
    "Tandek", "Pintasan", "Tempasuk", "Usukan", "Kadamaian", "Sulaman",
    "Pantai Dalit", "Tamparuli", "Kiulu", "Karambunai", "Darau", "Inanam",
    "Likas", "Api-Api", "Luyang", "Tanjong Aru", "Petagas", "Tanjung Keramat",
    "Kapayan", "Moyog", "Limbahau", "Kawang", "Pantai Manis", "Bongawan",
    "Membakut", "Klias", "Kuala Penyu", "Lumadan", "Sindumin", "Kundasang",
    "Karanaan", "Paginatan", "Tambunan", "Bingkor", "Liawan", "Melalap",
    "Kemabong", "Tulid", "Sook", "Nabawan", "Telupid", "Sugut",
    "Labuk", "Gum-Gum", "Sungai Manila", "Sungai Sibuga", "Sekong", "Karamunting",
    "Elopura", "Tanjong Papat", "Kuamut", "Lamag", "Sukau", "Tungku",
    "Segama", "Silam", "Kunak", "Sulabayan", "Senallang", "Bugaya",
    "Balung", "Apas", "Sri Tanjong", "Kukusan", "Tanjung Batu", "Merotai",
    "Sebatik",
  ],
  sarawak: [
    "Opar", "Tasik Biru", "Tanjong Datu", "Pantai Damai", "Demak Laut", "Tupong",
    "Samariang", "Satok", "Padungan", "Pending", "Batu Lintang", "Kota Sentosa",
    "Batu Kitang", "Batu Kawah", "Asajaya", "Muara Tuang", "Stakan", "Serembu",
    "Mambong", "Tarat", "Tebedu", "Kedup", "Bukit Semuja", "Sadong Jaya",
    "Simunjan", "Gedong", "Sebuyau", "Lingga", "Beting Maro", "Balai Ringin",
    "Bukit Begunan", "Simanggang", "Engkilili", "Batang Ai", "Saribas", "Layar",
    "Bukit Saban", "Kalaka", "Krian", "Kabong", "Kuala Rajang", "Semop",
    "Daro", "Jemoreng", "Repok", "Meradong", "Pakan", "Meluan",
    "Ngemah", "Machan", "Bukit Assek", "Dudong", "Bawang Assan", "Pelawan",
    "Nangka", "Dalat", "Tellian", "Balingian", "Tamin", "Kakus",
    "Pelagus", "Katibas", "Bukit Goram", "Baleh", "Belaga", "Murum",
    "Jepak", "Tanjong Batu", "Kemena", "Samalaju", "Bekenu", "Lambir",
    "Piasau", "Pujut", "Senadin", "Marudi", "Telang Usan", "Mulu",
    "Bukit Kota", "Batu Danau", "Ba`Kelalan", "Bukit Sari",
  ],
  selangor: [
  ...
  terengganu: [
    "Kuala Besut", "Kota Putera", "Jertih", "Hulu Besut", "Jabi", "Permaisuri",
    "Langkap", "Batu Rakit", "Tepuh", "Buluh Gading", "Seberang Takir", "Bukit Tunggal",
    "Wakaf Mempelam", "Bandar", "Ladang", "Batu Buruk", "Alur Limbat", "Bukit Payung",
    "Ru Rendang", "Pengkalan Berangan", "Telemung", "Manir", "Kuala Berang", "Ajil",
    "Bukit Besi", "Rantau Abang", "Sura", "Paka", "Kemasik", "Kijal",
    "Cukai", "Air Putih",
  ],
};
